...
{
	whs_controller wafer_sys_control = whs_controller("192.168.0.214", 8882, "192.168.0.104", 24687);
	...
	while (choice != CLOSE) {
			...
			std::cout<<"10: GET AXIS. get axis positon \n";
			std::cin >> choice;
            ...
            case GET_AXIS:
			    std::cout<<"The axis position "<<wafer_sys_control.get_axis_position()<<"\n";
				std::cout<<" The motion velocity "<<wafer_sys_control.get_axis_ptr()->get_speed()<<"\n";
				break;
			default:
